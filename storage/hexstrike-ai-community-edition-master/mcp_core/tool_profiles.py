...
TOOL_PROFILES = {
    ...
    #Tools for network scanning and enumeration (e.g., Nmap, ARP-Scan, Masscan, Naabu, Rustscan, Kscan).
    "net_scan": [
        ...
        lambda mcp, client, logger: register_naabu_tool(mcp, client, logger),
        lambda mcp, client, logger: register_rustscan_tool(mcp, client, logger),
        lambda mcp, client, logger: register_fscan_tool(mcp, client, logger),
        lambda mcp, client, logger: register_kscan_tool(mcp, client, logger),
    ],
    ...
    "fingerprint": [
        ...
        lambda mcp, client, logger: register_ehole_tool(mcp, client, logger),
    ],
    ...
    "vuln_scan": [
        ...
        lambda mcp, client, logger: register_afrog_tool(mcp, client, logger),
        lambda mcp, client, logger: register_pocbomber_tool(mcp, client, logger),
        lambda mcp, client, logger: register_springboot_scan_tool(mcp, client, logger),
    ],
    ...
    #Tools for URL discovery and reconnaissance (e.g., Gau, Waybackurls, URLFinder).
    "url_recon": [
        ...
        lambda mcp, client, logger: register_urlfinder_tool(mcp, client, logger),
    ],
    ...
    # Tongling storage tools (统领 tools_config.json + toollist CLI)
    "tongling": [
        lambda mcp, client, logger: register_tongling_tools(mcp, client, logger),
    ],
}
