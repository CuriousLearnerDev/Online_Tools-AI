...
BINARY_NAME_OVERRIDES = {
    "scout-suite": "scout",
    "volatility": "vol",
    # NetExec 安装后命令名多为 netexec，健康检查里登记的是 nxc
    "nxc": "netexec",
    "ehole": "ehole.exe",
    "urlfinder": "URLFinder",
}
...
HEALTH_TOOL_CATEGORIES = {
    ...
    "network_recon": ["rustscan", "fscan", "kscan", "masscan", "naabu", "autorecon", "nbtscan", "arp-scan", "responder",
    ...
    "web_recon": ["ffuf", "feroxbuster", "dirsearch", "dotdotpwn", "xsser", "wfuzz",
                     ...
                     "httpx", "wafw00f", "burpsuite", "katana", "hakrawler", "urlfinder", "wpscan", "joomscan"],
    "web_vuln": ["nuclei", "afrog", "pocbomber", "springboot-scan", "graphql-scanner", "jwt-analyzer", "zaproxy"],
