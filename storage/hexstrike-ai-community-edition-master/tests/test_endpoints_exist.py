...
class TestNetworkScanning:
    ...
    def test_naabu(self, client):
        r = _post(client, "/api/tools/naabu")
        assert_route_exists(r, "/api/tools/naabu")

    def test_rustscan(self, client):
        r = _post(client, "/api/tools/rustscan")
        assert_route_exists(r, "/api/tools/rustscan")

    def test_fscan(self, client):
        r = _post(client, "/api/tools/fscan")
        assert_route_exists(r, "/api/tools/fscan")

    def test_kscan(self, client):
        r = _post(client, "/api/tools/kscan")
        assert_route_exists(r, "/api/tools/kscan")
...
class TestWebScanning:
    ...
    def test_afrog(self, client):
        r = _post(client, "/api/tools/afrog")
        assert_route_exists(r, "/api/tools/afrog")

    def test_pocbomber(self, client):
        r = _post(client, "/api/tools/pocbomber")
        assert_route_exists(r, "/api/tools/pocbomber")

    def test_springboot_scan(self, client):
        r = _post(client, "/api/tools/springboot-scan")
        assert_route_exists(r, "/api/tools/springboot-scan")
...
class TestURLRecon:
    ...
    def test_urlfinder(self, client):
        r = _post(client, "/api/tools/urlfinder")
        assert_route_exists(r, "/api/tools/urlfinder")
