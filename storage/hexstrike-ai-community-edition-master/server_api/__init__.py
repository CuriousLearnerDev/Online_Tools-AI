...
def register_blueprints(app):
  ...
  app.register_blueprint(api_osint_ehole_bp)
  ...
  app.register_blueprint(api_url_recon_urlfinder_bp)
  ...
  app.register_blueprint(api_net_scan_fscan_bp)
  app.register_blueprint(api_net_scan_kscan_bp)
  app.register_blueprint(api_net_scan_masscan_bp)
  app.register_blueprint(api_net_scan_naabu_bp)
  ...
  app.register_blueprint(api_vuln_scan_afrog_bp)
  app.register_blueprint(api_vuln_scan_pocbomber_bp)
  app.register_blueprint(api_vuln_scan_springboot_scan_bp)
  ...
  # Web UI — 统领模式仅通过 /tongling/hs/ 内嵌，不暴露根路径仪表盘
  if not os.environ.get("TONGLING_ROOT"):
  ...
  # Tongling storage tools (tools_config + toollist CLI)
