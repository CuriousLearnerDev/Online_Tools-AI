...
export const DEMO_TOOLS: Tool[] = [
  ...
  { name: 'naabu',         desc: 'ProjectDiscovery Naabu — fast TCP port enumeration',             category: 'network_recon', endpoint: '/api/tools/naabu',         method: 'POST', params: {},                                                      optional: { host: '', host_file: '', ports: '', top_ports: '', rate: '1000', c: '25', scan_type: 'c', silent: false, json_lines: false, csv: false, output: '', interface: '', exclude_hosts: '', verify: false, additional_args: '' }, effectiveness: 0.93 },
  { name: 'kscan',         desc: 'Kscan — ports, fingerprints, FOFA/spy, optional hydra',          category: 'network_recon', endpoint: '/api/tools/kscan',         method: 'POST', params: {},                                                      optional: { target: '', fofa: '', use_spy: false, spy_scope: '', fofa_syntax: false, check: false, scan: false, port: '', output: '', output_json: '', output_csv: '', Pn: false, Cn: false, Dn: false, sV: false, top: 0, proxy: '', threads: 0, path: '', request_host: '', timeout: 0, encoding: '', match: '', not_match: '', hydra: false, hydra_user: '', hydra_pass: '', hydra_update: false, hydra_mod: '', fofa_size: 0, fofa_fix_keyword: '', additional_args: '' }, effectiveness: 0.91 },
  ...
  // ── Web Recon ──
  { name: 'gobuster',     desc: 'Directory and file brute-forcer',                          category: 'web_recon', endpoint: '/api/tools/gobuster',     method: 'POST', params: { url: r() },    optional: { mode: 'dir', wordlist: '..\common.txt', additional_args: '' },                                                              effectiveness: 0.90 },
  { name: 'ffuf',         desc: 'Fast web fuzzer for dirs, vhosts, params',                 category: 'web_recon', endpoint: '/api/tools/ffuf',         method: 'POST', params: { url: r() },    optional: { wordlist: '..\common.txt', mode: 'directory', match_codes: '200,204,301,302,307,401,403', additional_args: '' },            effectiveness: 0.90 },
  { name: 'feroxbuster',  desc: 'Recursive content discovery',                              category: 'web_recon', endpoint: '/api/tools/feroxbuster',  method: 'POST', params: { url: r() },    optional: { wordlist: '..\common.txt', threads: 10, additional_args: '' },                                                             effectiveness: 0.85 },
  ...
  { name: 'dirb',         desc: 'Classic web content scanner using a wordlist',             category: 'web_recon', endpoint: '/api/tools/dirb',         method: 'POST', params: { url: r() },    optional: { wordlist: '..\common.txt', additional_args: '' },                                                                          effectiveness: 0.78 },
  ...
  { name: 'urlfinder',    desc: 'URLFinder — extract JS and URLs from pages (hidden API paths)', category: 'web_recon', endpoint: '/api/tools/urlfinder', method: 'POST', params: {}, optional: { url: '', url_file: '', url_file_one: '', user_agent: '', base_url: '', cookie: '', domain: '', config_file: '', mode: 1, max: 99999, out_file: '', status: '', thread: 50, timeout: 5, proxy: '', fuzz: 0, additional_args: '' }, effectiveness: 0.86 },
  ...
  { name: 'wfuzz',               desc: 'Web fuzzer for directories, parameters, and authentication',             category: 'web_vuln', endpoint: '/api/tools/wfuzz',               method: 'POST', params: { url: r() },           optional: { wordlist: '..\common.txt', additional_args: '' },            effectiveness: 0.82 },
...
const HEALTH_CAT_TOOLS: Record<string, string[]> = {
  ...
  network:       ['rustscan', 'masscan', 'fscan', 'kscan', 'autorecon', 'nbtscan', 'arp-scan', 'responder', 'nxc', 'enum4linux-ng', 'rpcclient', 'enum4linux'],
  web_security:  ['ffuf', 'feroxbuster', 'dirsearch', 'dotdotpwn', 'xsser', 'wfuzz', 'gau', 'waybackurls', 'urlfinder', 'arjun', 'paramspider', 'x8', 'jaeles', 'dalfox', 'httpx', 'wafw00f', 'burpsuite', 'zaproxy', 'katana', 'hakrawler'],
